...
//i = 0, 1, 2, 3, 4, 5
//j= array.length -1 (gives the last index) - i
//then compare array[i] to array[j] if not equal return false
//loop through the entire array and never return false then 
//return true outside of the array
